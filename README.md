...
2. react-dom
* Точка входа в DOM и средства рендеринга для React

3. react-router-dom
* Используется для маршрутизации web приложения

4. react-scripts
* Используется для создания react приложения

5. react-speech-recognition
* Используется в игре "Скажи это" для распознования речи

6. react-beautiful-dnd
* Используется в игре "Головоломка" для перетаскивания слов (пазлов)

7. recharts
* Используется для создания графиков для игр на странице "Статистики"
...
9. Ant Design
* Используется для добавления React компонентов

10. Ant-design/icons
* Используется для добавления иконок

11. uuid
* Используется для генерации уникальный ключей
