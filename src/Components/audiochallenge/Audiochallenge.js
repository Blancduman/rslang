...
<Title level={1}><Text  strong > АУДИОВЫЗОВ</Text></Title>
<Title level={4}><Text  strong > Тренировка улучшает восприятие английской речи на слух.</Text></Title>
            <Button className="start_game-btn" onClick={startGame}>СТАРТ</Button>
          </div>
        )}
      </main>
    </div>
